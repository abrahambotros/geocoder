...
class TestMath(unittest.TestCase):
    ...
    def test_equalish(self):
        ...
        self.assertTrue(equalish(x=0.55555, y=0.55556, precision_digits=3))
        self.assertTrue(equalish(x=0.55555, y=0.55556, precision_digits=4))
        self.assertFalse(equalish(x=0.55555, y=0.55556, precision_digits=5))
        self.assertFalse(equalish(x=0.55555, y=0.55556, precision_digits=6))
