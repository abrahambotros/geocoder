...
ADDRESS_TO_LATLNG_DICT: Dict[str, LatLng] = {
    ...
    # "colossus of rhodes": LatLng(lat=36.451066, lng=28.225833),  # Unhandled by HERE.
    # "Great Pyramid of Giza": LatLng(lat=29.979235, lng=31.134202),  # Unhandled by HERE.
    # "hanging gardens of babylon": LatLng(lat=48.919861, lng=2.343222),  # Unhandled by HERE.
}
